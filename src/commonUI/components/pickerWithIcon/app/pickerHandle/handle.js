...
class Handle extends Component {
    ...
    */
    ...
    render(){
        return (
            <View style={[styles.nav, this.props.navStyle, {marginTop: 20}]}>
                ...
                <TouchableOpacity  style={styles.confirm} onPress={() => {this.props.confirmChose();}}>
                    <Text className={'confirm'} style={[styles.confirmBtnStyle,this.props.confirmBtnStyle]}>{this.props.confirmBtnText}</Text>
                </TouchableOpacity>
            </View>
        );
    }
